...
function PANEL:Init()
	...
	self.RightContentPanel:AddSheet("Tools", vgui.Create("purge_ShopMenu_Tools", self.RightFrame), "icon16/wrench.png")
	local PropProtection = vgui.Create("purge_ShopMenu_PropProtection", self.RightFrame)
...
vgui.Register("purge_ShopMenu", PANEL)
